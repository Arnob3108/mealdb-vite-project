    ...
    <div>
      <div className="relative flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0">
        <div className="inset-y-0 top-0 right-0 z-0 w-full max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-7/12 lg:max-w-full lg:absolute xl:px-0">
          <svg
            className="absolute left-0 hidden h-full text-amber-300 transform -translate-x-1/2 lg:block"
            viewBox="0 0 100 100"
            fill="currentColor"
          ...
          <img
            ...
            src="https://th.bing.com/th/id/R.21cc41f07a4cb490845a6be54b5a2adb?rik=KpB%2bdn0IV0ZPPg&pid=ImgRaw&r=0"
            alt=""
          />
        </div>
          ...
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            ...
            <div className="flex items-center">
              ...
              <Link
                to="/about"
                aria-label=""
                className="inline-flex items-center font-semibold text-indigo-800 transition-colors duration-200 hover:text-amber-700"
              >
                Learn more
              </Link>
            </div>
